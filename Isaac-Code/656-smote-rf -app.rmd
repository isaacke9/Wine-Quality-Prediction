...
```
```{r}
#data_bal = data.frame(X_presmote, 'quality' = Y_presmote)
# data_bal = smote_data1
# data_bal = smote_data2
# data_bal = smote_data3
...
X = dplyr::select(data_bal, -quality) 
...
rf_smote_res = data.frame('round' = seq(0,4), 
                          'accuracy' = c(0.6596295, 0.7494328, 0.8086329, 0.8342432, 0.8422451)
           )

ggplot(data=rf_smote_res, aes(x=round, y=accuracy)) +
  geom_step(size=1.5)+
  geom_point(size=3)+
